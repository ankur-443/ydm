...
function himalayas_footer_copyright() {
	...
	$google_link = '<a href="https://images.google.com/" target="_blank" title="' . esc_attr__( 'Image Source', 'himalayas' ) . '">' . __( 'Image Source', 'himalayas' ) . '</a>';

	$default_footer_value = '<span class="copyright-text">' . sprintf( __( 'Copyright &copy; %1$s %2$s.', 'himalayas' ), date( 'Y' ), $site_link ).' '.sprintf( __( '%s.', 'himalayas' ), $google_link ) . '</span>';
